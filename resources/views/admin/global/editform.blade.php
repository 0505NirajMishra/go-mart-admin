<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4 fv-row">
            {!! Form::textarea('address', null, [
                ...
                'value' => 2,
                'class' => 'form-control form-control-lg form-control-solid',
                'placeholder' => trans_choice('content.address', 1),
            ]) !!}
        </div>
        ...
        <div class="col-lg-4 fv-row">
            {!! Form::text('email', null, [
                ...
                'value' => 2,
                'class' => 'form-control form-control-lg form-control-solid',
                'placeholder' => trans_choice('content.email
                ', 1),
            ]) !!}
        </div>
    ...
    <div class="row mb-6">
        ...
        <label class="col-lg-2 col-form-label required fw-bold fs-6">RAZORPAY_KEY</label>
        <div class="col-lg-4 fv-row">
        ...
        <label class="col-lg-2 col-form-label required fw-bold fs-6">RAZORPAY_SECRET</label>
        <div class="col-lg-4 fv-row">
            {!! Form::text('razorpay_secert', null, [
                'min' => 2,
                'max' => 6,
                'value' => 2,
                'class' => 'form-control form-control-lg form-control-solid',
                'placeholder' => trans_choice('content.razorpay_secert', 1),
            ]) !!}
        </div>
