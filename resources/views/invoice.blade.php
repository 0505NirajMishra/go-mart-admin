											...
											<tr>
												...
												<td class="column column-3"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-left:5px;padding-right:10px;padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div class=""
											...
											<tr>
												...
												<td class="column column-2"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														width="100%">
														<tr>
															<td class="pad" style="padding-left:10px;padding-top:3px;">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 16.8px; color: #9a9a9a; line-height: 1.2;">
																		<p
																			style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 16.8px;">
																			<strong>Date :<br /></strong></p>
																	</div>
																</div>
															</td>
														</tr>
												...
												<td class="column column-3"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-left:5px;padding-right:10px;padding-top:3px;">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 16.8px; color: #000000; line-height: 1.2;">
																		<p
						...
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content"
										role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #000000; color: #000000; width: 640px;"
										width="640">
										<tbody>
											<tr>
												<td class="column column-1"
												...
												<td class="column column-2"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														width="100%">
														<tr>
															<td class="pad" style="padding-left:5px;padding-top:5px;">
																<div style="font-family: sans-serif">
																	<div class=""
													...
													<table border="0" cellpadding="5" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 12px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #000000; line-height: 1.2;">
																		<p
																			style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
																			 </p>
																	</div>
